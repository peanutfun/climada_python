...
WS_DEMO_NC = [
    DEMO_DIR.joinpath("fp_lothar_crop-test.nc"),
...
CMAP_EXPOSURES = mpl.colors.LinearSegmentedColormap.from_list(
    "cmr.sunburst", cm_data1, N=256
).reversed()
"""Default sequential colormaps, taken from https://cmasher.readthedocs.io/index.html"""
CMAP_EXPOSURES.set_under("lightgray")

CMAP_IMPACT = mpl.colors.LinearSegmentedColormap.from_list(
    "cmr.flamingo", cm_data2, N=256
).reversed()
"""Default sequential colormaps, taken from https://cmasher.readthedocs.io/index.html"""
