...
class TestCreateIconName(unittest.TestCase):
    ...
    def test_icon_name(self):
        ...
        self.assertEqual(
            url,
            ("https://opendata.dwd.de/weather/nwp/" + "icon-eu-eps/grib/00/vmax_10m/"),
        )
        self.assertEqual(
            file_name,
            (
...
class TestDeleteIcon(unittest.TestCase):
    ...
    def test_rm_file(self):
        ...
        delete_icon_grib(
            dt.datetime(1908, 2, 2), max_lead_time=1, download_dir=SYSTEM_DIR
        )
...
if __name__ == "__main__":
    ...
    TESTS.addTests(
        unittest.TestLoader().loadTestsFromTestCase(TestDownloadIconCentroids)
    )
