...
class TestContainer(unittest.TestCase):
    ...
    def test_add_wrong_error(self):
        ...
        with self.assertLogs(
            "climada.entity.impact_funcs.impact_func_set", level="WARNING"
        ) as cm:
...
class TestReaderMat(unittest.TestCase):
    ...
    def test_demo_file_pass(self):
        ...
        self.assertEqual(
            imp_funcs._data[hazard][first_id].name, "Tropical cyclone default"
        )
        self.assertEqual(imp_funcs._data[hazard][first_id].intensity_unit, "m/s")

        self.assertEqual(imp_funcs._data[hazard][first_id].intensity.shape, (9,))
        ...
        self.assertEqual(imp_funcs._data[hazard][second_id].name, "TC Building code")
        self.assertEqual(imp_funcs._data[hazard][first_id].intensity_unit, "m/s")

        self.assertEqual(imp_funcs._data[hazard][second_id].intensity.shape, (9,))
