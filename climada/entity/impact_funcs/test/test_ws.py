...
class TestStormEuropeDefault(unittest.TestCase):
    ...
    def test_default_values_pass(self):
        ...
        self.assertTrue(
            np.array_equal(
                imp_fun.intensity,
                np.array([0, 20, 25, 30, 35, 40, 45, 50, 55, 60, 80, 100]),
            )
        )
        self.assertTrue(
            np.array_equal(
                imp_fun.paa[4:8], np.array([0.03921, 0.10707, 0.25357, 0.48869])
            )
        )
        self.assertTrue(
            np.array_equal(
                imp_fun.mdd[4:8],
                np.array([0.00367253, 0.00749977, 0.01263556, 0.01849639]),
            )
        )
        ...
        self.assertTrue(
            np.array_equal(
                imp_fun2.intensity[np.arange(0, 120, 13)],
                np.array([0.0, 10.0, 20.0, 30.0, 40.0, 50.0, 60.0, 70.0, 80.0, 90.0]),
            )
        )
        self.assertTrue(
            np.allclose(
                imp_fun2.paa[np.arange(0, 120, 13)],
                np.array(
                    [
                        0.0,
                        0.0,
        ...
        self.assertTrue(
            np.allclose(
                imp_fun2.mdd[np.arange(0, 120, 13)],
                np.array(
                    [
                        0.0,
                        0.0,
